...
class S3StorageProvider(StorageProvider):
    def __init__(self):
        config = Config(
            ...
            # KIT change - see https://github.com/boto/boto3/issues/4400#issuecomment-2600742103âˆ†
    ...
    def sanitize_tag_value(s: str) -> str:
        ...
        return re.sub(r"[^a-zA-Z0-9 Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸ\+\-=\._:/@]", "", s)
        ...
        try:
            ...
            if "Contents" in response:
                for content in response["Contents"]:
                    # Skip objects that were not uploaded from synergy-ui in the first place
