...
def remove_SYNERGY_UI_params(params: dict) -> dict:
    """
    Removes synergyui specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with synergyui parameters removed.
    """
    SYNERGY_UI_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_SYNERGY_UI_params(params)
