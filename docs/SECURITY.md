...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on synergy-ui.
...
Any reports or solicitations arriving from sources other than our designated GitHub repository will be dismissed without consideration. Weâ€™ve seen how external engagements can dilute and compromise the integrity of community-driven projects, and weâ€™re not here to gamble with the security and privacy of our user community.
...
7. **Default Configuration Testing**: All vulnerability reports MUST be tested and reproducible using Synergy UI's out-of-the-box default configuration. Claims of vulnerabilities that only manifest with explicitly weakened security settings may be discarded, unless they are covered by the following exception:
...
8. **Threat Model Understanding Required**: Reports must demonstrate understanding of Synergy UI's self-hosted, authenticated, role-based access control architecture. Comparing Synergy UI to services with fundamentally different security models without acknowledging the architectural differences may result in report rejection.
...
>
> - If we suspect you used AI (but you did not disclose it to us), we will be asking tough follow-up questions to validate your understanding of the reported vulnerability and Synergy UI itself.
...
> - had a clear lack of understanding of Synergy UI
...
If you want to report a vulnerability and can meet the outlined requirements, [open a vulnerability report here](https://github.com/synergy-ui/synergy-ui/security/advisories/new).
...
- **Documentation issues/improvement ideas:** Open an issue on our [Documentation Repository](https://github.com/synergy-ui/docs)
- **Feature requests:** Create a discussion in [GitHub Discussions - Ideas](https://github.com/synergy-ui/synergy-ui/discussions/) to discuss with the community if this feature request is wanted by multiple people
- **Configuration help:** Ask the community for help and guidance on our [Discord Server](https://discord.gg/5rJgQTnV4s) or on [Reddit](https://www.reddit.com/r/synergyui/)
- **General issues:** Use our [Issue Tracker](https://github.com/synergy-ui/synergy-ui/issues)
...
For any other immediate concerns, please create an issue in our [issue tracker](https://github.com/synergy-ui/synergy-ui/issues) or contact our team on [Discord](https://discord.gg/5rJgQTnV4s).
