						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									...
									{#if $config?.features?.enable_version_update_check}
										<a
											href="https://github.com/synergy-ui/synergy-ui/releases/tag/v{version.latest}"
											target="_blank"
										>
											{updateAvailable === null
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use Synergy UI and seek support from the community.')}
								</div>
							</div>

							<a
								class="flex-shrink-0 text-xs font-medium underline"
								href="https://docs.synergyui.com/"
								target="_blank"
							>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								<a href="https://discord.gg/5rJgQTnV4s" target="_blank">
									<img
										alt="Discord"
										src="https://img.shields.io/badge/Discord-SYNERGY_UI-blue?logo=discord&logoColor=white"
									/>
								</a>

								<a href="https://twitter.com/synergyui" target="_blank">
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/twitter/follow/synergyui"
									/>
								</a>

								<a href="https://github.com/synergy-ui/synergy-ui" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/synergy-ui/synergy-ui?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a
										href="https://docs.synergyui.com/enterprise"
										target="_blank"
						...
						{#if adminConfig?.ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2 mb-2.5">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://docs.synergyui.com/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://docs.synergyui.com/getting-started/api-endpoints"
										target="_blank"
							...
							<div class="mt-2 text-xs">
								...
								>
									<div>
										...
										<span
											><a
												href="https://docs.synergyui.com/getting-started/env-configuration#jwt_expires_in"
												target="_blank"
												class=" underline"
